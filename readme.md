...
```"GAME_SERVER_LIST": '{"games": [{"FriendlyName": "valheim", "ContainerName": "valheim-valheim-crossplay-1"}, {"FriendlyName": "cncnet", "ContainerName": "cncnet-server"}, {"FriendlyName": "satisfactory", "ContainerName": "satisfactory-server"}]}'```
